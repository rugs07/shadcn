...
function ToDo() {
  ...
  return (
    <>
      {loading && <PageLoader text="Loading tasks..." isDark={true} />}
      <div className="max-w-md mx-auto mt-10 p-4 border  bg-white shadow-lg" style={{ filter: loading ? 'blur(2px)' : 'none', pointerEvents: loading ? 'none' : 'auto' }}>
